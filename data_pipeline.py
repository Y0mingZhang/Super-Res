...
def get_loaders(args):
    ...
    test_loader = torch.utils.data.DataLoader(list(zip(data_test.lr[:1000], data_test.hr[:1000])), batch_size=args.batch_size, shuffle=False)
    val_loader = torch.utils.data.DataLoader(list(zip(data_test.lr[1000:], data_test.hr[1000:])), batch_size=args.batch_size, shuffle=False)
